			...
			<div class="features-div flex flex-col items-center">
				...
				<div class="flex flex-col md:flex-row gap-6 ">
					<div class="flex flex-col bg-primary-background rounded-xl py-10 px-6 items-center">
						<img class="h-14 w-14" src="../public/tournament.png"></img>
					...
					<div class="flex flex-col bg-primary-background rounded-xl py-10 px-6 items-center">
						<img class="h-14 w-14" src="../public/matchmaking.png"></img>
					...
					<div class="flex flex-col bg-primary-background rounded-xl py-10 px-6 items-center">
						<img class="h-14 w-14" src="../public/remote.png"></img>
					...
					<div class="flex flex-col bg-primary-background rounded-xl py-10 px-6 items-center">
						<img class="h-14 w-14" src="../public/stats.png"></img>
