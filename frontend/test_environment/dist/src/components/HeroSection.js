export function renderHeroSection() {
			...
			<div class="hero-div flex flex-col md:flex-row justify-around items-center h-screen">
				<div class="hero-div-left w-full md:w-6/12">
					...
					<div class="flex flex-row gap-2":>
						<div>
							<a href="/safe/login" data-link>
								<button id="loginButton" type="button" class="text-base md:text-base text-white bg-primary my-3 py-2 px-5 rounded-md flex items-center whitespace-nowrap hover:text-primary hover:bg-white">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" />
						...
						<div>
						<a href="/safe/register" data-link>
								<button type="button" data-link class="text-base md:text-base text-primary bg-white my-3 py-2 px-5 rounded-md flex items-center whitespace-nowrap hover:text-white hover:bg-primary">
								<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-2">
