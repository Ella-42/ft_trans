...
export async function renderPrivacyPolicy(): Promise<string> {
			...
			<main class="flex-1 container px-5 py-10 mx-auto max-w-4xl">
				...
				<section class="space-y-6 text-white">
					...
					<div>
						...
						<p class="pl-3">The email and password are hashed before being sent to the database so we do not store these values as plain text and cannot even read them ourselves.</p>
					...
					<div>
						...
						<p class="pl-3">We may contact you by email for verification purposes, this is done to prevent issues like hijacking accounts.</p>
					</div>
					<div>
					...
					<div>
						...
						<p class="pl-3">You have the right to request access to, correction of, or deletion of your personal data. To exercise these rights, access these features in the settings page in the dashboard once you are logged in. To make an access request of your data, you may contact us at <a href="mailto:EllaP.jobs@gmail.com" class="text-primary underline">EllaP.jobs@gmail.com</a>.</p>
					...
					<div>
						...
						<p class="pl-3">Passwords and email addresses are hashed before being stored in the database, meaning that even if unauthorized access was somehow achieved, any perpetrator would not gain much.</p>
					</div>
					<div>
