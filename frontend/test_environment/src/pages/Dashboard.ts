...
export const renderDashboard = (user: User): string => {
	...
	<section class="flex h-screen">
		...
		<section class="flex flex-col w-full h-full">
			...
			<section class="bg-primary-background text-white w-full flex-1 justify-between">
				<div class="container px-5 flex flex-col md:flex-col flex-1">
					<div class="px-10 py-5 rounded-xl my-5 mb-10 bg-gray-900 flex justify-between items-center">
						...
						<p class="font-extralight hidden md:block">${date}</p>
					</div>
					<div>
						<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
							<div class="px-10 py-5 rounded-xl bg-gray-900">
