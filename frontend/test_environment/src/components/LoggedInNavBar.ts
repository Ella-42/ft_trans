		...
		<nav class="bg-gray-900 h-20 hidden md:block">
			...
			<div class="h-20 flex justify-between items-center">
				...
				<div class="flex items-center gap-3 mr-10">
					<a href="/safe#home"><p class="text-white">Home</p></a>
					<h2 class="text-white text-base ml-10">${user.nickname}</h2>
					<button class="logout-btn ml-10 text-base text-white bg-primary my-3 py-2 px-4 rounded-md flex items-center whitespace-nowrap hover:text-primary hover:bg-white">Logout</button>
				</div>
			</div>
		</nav>
		...
		<nav class="bg-primary-background md:hidden">
			<div class="container px-5 md:px-10 md:flex items-center justify-between gap-6">
				<div class="flex items-center justify-between">
					<a data-link href="/safe#home" id="home" class="py-1 px-2"><img class="h-20" src="/safe/public/pong-logo-png.png"></img></a>
				...
				<div class="hidden flex md:flex md:flex-row flex-col items-center justify-start pb-5 md:space-x-5 pb-3 md:pb-0 navigation-menu-logged-in">
					<a data-link href="/safe#home" class="text-base py-2 text-white">Home</a>
					...
					<button class="logout-btn text-base text-white bg-primary mt-2 py-2 px-4 rounded-md flex items-center whitespace-nowrap hover:text-primary hover:bg-white">Logout</button>
				</div>
			</div>
		</nav>
  `;
